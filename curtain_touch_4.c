 ...
 * File:   main.c
 * Author: Alfaone
 * Module: 4 switches for 2 curtain
 * PCB USED: 5.4G17
 * Created on 10 October, 2018, 12:15 PM
 */
...
#define OUTPUT_RELAY4 RA2
#define OUTPUT_RELAY3 RA3
...
int curatin1_timeCompleted=0;
int curatin2_timeCompleted=0;
int preventFlag=0;
#define ON 1
#define OFF 0
#define CHAR_OFF '0'
...
void sendFeedback_TO_Touch_Main(char Switch_Num_1s, char Switch_state_MSB, char Switch_state_LSB);
void actiontouchPanel(char Switch_Num, char sw_status, char curtain_status);//, char speeds
void sendFeedback_TO_Touch_ISR(char Switch_Num,char Switch_state_MSB,char Switch_state_LSB);
...
int main() {
  ...
  OUTPUT_RELAY4 = 0;
    ...
    while(1){
        ...
        if(curatin1_timeCompleted == TRUE)
        {
                 curatin1_timeCompleted=FALSE;
                    T1CONbits.TMR1ON=0;
                  timerCounter1=0;
                   curtFlag1=0;
                   sendFeedback_TO_Touch_ISR('A','0','0');__delay_ms(3);
                   sendFeedback_TO_Touch_ISR('A','0','0');
                    OUTPUT_RELAY1=0;
                    sendFeedback_TO_Touch_ISR('A','0','0');
                    __delay_ms(1);
                    ...
                    sendFeedback_TO_Touch_ISR('C','0','0');__delay_ms(3);
                    sendFeedback_TO_Touch_ISR('C','0','0');
                    OUTPUT_RELAY2=0;  __delay_ms(1); sendFeedback_TO_Touch_ISR('C','0','0');
                    IsrResponse[0]='G'; IsrResponse[1]='0'; IsrResponse[2]='0'; IsrResponse[3]='1';
                    IsrFeedback(IsrResponse);     __delay_ms(1);
        }
        //check for time completion for curtain 2
        if(curatin2_timeCompleted == TRUE)
        {
                        curatin2_timeCompleted=FALSE; 
                        T3CONbits.TMR3ON = 0; 
                        timerCounter2=0;
                       curtFlag2=0;
                     sendFeedback_TO_Touch_ISR('B','0','0');__delay_ms(3);
                     sendFeedback_TO_Touch_ISR('B','0','0');
                    OUTPUT_RELAY3=0;__delay_ms(1); sendFeedback_TO_Touch_ISR('B','0','0');
                    IsrResponse[0]='G'; IsrResponse[1]='0'; IsrResponse[2]='0'; IsrResponse[3]='3';
                    IsrFeedback(IsrResponse);
                     sendFeedback_TO_Touch_ISR('D','0','0');
                    OUTPUT_RELAY4=0; __delay_ms(1);sendFeedback_TO_Touch_ISR('D','0','0');
                    sendFeedback_TO_Touch_ISR('D','0','0');
...
//    char ch_sw_num = SwNum +'0';//send '1' for switch A, '2' for sww2 and so on 
  //  sendFeedback_TO_Gateway(sw_status,ch_sw_num);
    ...
    //TOuch panel frame(cA/B/C/D1100)/(cA/B/C/D0000),<start bit><Address><switch status><curtain_status><0><0><stop bit>
...
//                    if(charFinalFrameState == '1'){
////                            sendFeedback_TO_Touch_ISR('A','1','1');
//                        
//                        __delay_ms(10);
//                        TX2REG = '(' ;
//                        __delay_ms(1);
...
//                    if(charFinalFrameState == '1'){
////                            sendFeedback_TO_Touch_Main('A','0','0');
//                        
//                        __delay_ms(10);
//                        TX2REG = '(' ;
//                        __delay_ms(1);
...
//                       if(charFinalFrameState == '1'){
////                              sendFeedback_TO_Touch_Main('C','1','1');
//                           
//                        __delay_ms(10);
//                        TX2REG = '(' ;
//                        __delay_ms(1);
...
//                       if(charFinalFrameState == '1'){
////                            sendFeedback_TO_Touch_Main('C','0','0');
//                           
//                        __delay_ms(10);
//                        TX2REG = '(' ;
//                        __delay_ms(1);
...
//                                if(charFinalFrameState == '1'){
////                                    sendFeedback_TO_Touch_Main('B','1','1');
//                                                            __delay_ms(10);
//                        TX2REG = '(' ;
//                        __delay_ms(1);
//                        TX2REG = TouchMatikBoardAddress;//touchmatik address
...
//                                 if(charFinalFrameState == '1'){
////                                  sendFeedback_TO_Touch_Main('B','0','0');
//                                                             __delay_ms(10);
//                        TX2REG = '(' ;
//                        __delay_ms(1);
//                        TX2REG = TouchMatikBoardAddress;//touchmatik address
...
//                   if(charFinalFrameState == '1'){
////                       sendFeedback_TO_Touch_Main('D','1','1');
//                                               __delay_ms(10);
//                        TX2REG = '(' ;
//                        __delay_ms(1);
//                        TX2REG = TouchMatikBoardAddress;//touchmatik address
...
//                  if(charFinalFrameState == '1'){
////                   sendFeedback_TO_Touch_Main('D','0','0');
//                                                                     __delay_ms(10);
//                        TX2REG = '(' ;
//                        __delay_ms(1);
//                        TX2REG = TouchMatikBoardAddress;//touchmatik address
   ...
   if(charFinalFrameState == '1')
    {
                        ...
                        TX2REG = TouchMatikBoardAddress;//touchmatik address
                        __delay_ms(1);
                        if(charSwitchLSB == '1' || charSwitchLSB == '4')
                        {
                        TX2REG = charSwitchLSB+16;//A/D
                        }
                        else if(charSwitchLSB == '2')
                        {
                           TX2REG = charSwitchLSB+17;//C 
                        }
                        else if(charSwitchLSB == '3')
                        {
                            TX2REG = charSwitchLSB+15;//B
                        }
                        __delay_ms(1);
...
void sendFeedback_TO_Touch_ISR(char Switch_Num, char Switch_state, char curtain_Status){      
        __delay_ms(5);
        TX2REG = '(' ;
        __delay_ms(1);
        TX2REG = TouchMatikBoardAddress ;//touchmatik address
